				...
				<?php		
				    foreach ($_SESSION["cart_item"] as $item){
						?>
								...
								<td><a href="shop.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction">Remove Item</a></td>
								</tr>
								<?php
...
<div id="product-grid">
	<div class="txt-heading">Products <a id="btnEmpty" href="../next.php">Back</a></div>
	<?php
